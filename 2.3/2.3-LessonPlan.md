...
* Finally, visit <https://mean-google-maps.heroku.com>. Point out that this is a "real" website for adding users to a membership base. Have students complete the same rows and columns activity on the layout. 
...
* Finally as a tip for TAs + Instructors, there exists a bootstrap plugin for quickly creating bootstrap components in Sublime. Don't show students this yet. But keep it in the back of your mind. <https://github.com/JasonMortonNZ/bs3-sublime-plugin>.
...
* Let students know that media queries are what allow Twitter Bootstrap to have a fully mobile responsive website. But its important to be familiar with media queries so you can roll out your own custom mobile responsive designs in the future. 
